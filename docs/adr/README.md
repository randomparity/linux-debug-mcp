...
| [0026](0026-postmortem-crash-batch-runner.md) | `debug.postmortem.crash`: host-side pure-Python vmcore build-id reader, batch `!echo` sentinel framing, best-effort raw-passthrough parsers | Accepted |
