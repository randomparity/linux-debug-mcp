...
from kdive.providers.local.local_kernel_build import local_kernel_build_capability
...
from kdive.providers.local.qemu_gdbstub import local_qemu_gdbstub_capability
